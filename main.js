...
// Override quote form to WhatsApp for SN Cleaning
(function snQuote() {
  var form = document.getElementById("quote-form");
  if (!form) return;
  ...
  newForm.addEventListener("submit", function (e) {
    ...
    var text = [
      "Hi SN Cleaning — quote request from the website:",
      "",
      "Name: " + (data.name || "-"),
      "Phone: " + (data.phone || "-"),
      ...
      "Service: " + (data.pest_problem || "-"),
      data.message ? "Details: " + data.message : null,
    ].filter(Boolean).join("\n");
    window.open("https://wa.me/27765092245?text=" + encodeURIComponent(text), "_blank", "noopener");
  });
})();
